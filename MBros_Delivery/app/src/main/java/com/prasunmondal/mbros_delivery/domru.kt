...
import com.prasunmondal.mbros_delivery.LocationService.LocationUpdatesService
import kotlinx.android.synthetic.main.activity_domru.*
import java.text.DateFormat
import java.util.*

class domru : AppCompatActivity(),
NavigationView.OnNavigationItemSelectedListener {
    private val locationMsg: TextView? = null

    // as google doc says
    // Handler for incoming messages from the service.
    private var mHandler: JobServiceDemo.IncomingMessageHandler? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_domru)
